  ...
  methods: {
    ...
    getSeller: function getSeller() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/sellers/edit/' + this.id).then(function (response) {
        ...
        if (data.status === 1) {
          var _this4$record$admin$i, _this4$record$admin$u, _this4$record$admin$e, _this4$record$categor;
          ...
          _this4.categories_ids = (_this4$record$categor = _this4.record.categories) === null || _this4$record$categor === void 0 ? void 0 : _this4$record$categor.split(",");
